...
\nocite{*}
    ...
    \begin{frame}{Kinematic Model}
        ...
        \end{equation*}
        with $\bm{\dot{q}}_s$ velocities of the support joints
...
%        \end{align*}
    ...
    \begin{frame}{Extended Kalman Filter: Correction}
        %%% EKF Correction.
        To correct the predicted state we need to compute the innovation:
        \begin{equation*}
        ...
        \end{equation*}
        with $\bm{G}_{k+1}$ Kalman gain matrix, defined as
        \begin{equation*}
    ...
    \begin{frame}{Accelerometer Integration}
        Considering constant acceleration $\bm{\ddot{p}}_{t, k}$ in an
        interval $[t_k, t_{k+1})$:
        \begin{align*}
        ...
        \end{equation*}
        where $\alpha$, $\beta$ and $\gamma$ are, respectively,
    ...
    \begin{frame}{Gyroscope Integration}
        ...
        \begin{equation*}
            ...
            \end{pmatrix}
        \end{equation*}
        where $\beta$ and $\gamma$ are, respectively,
